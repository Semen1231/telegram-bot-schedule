...
# Railway использует переменные окружения напрямую, локально используем файлы
import os

# Проверяем, запущены ли мы на Railway (есть переменная RAILWAY_ENVIRONMENT)
if os.getenv('RAILWAY_ENVIRONMENT'):
    print("🚀 Railway деплой - используем переменные окружения")
    # На Railway не загружаем файлы, используем только переменные окружения
